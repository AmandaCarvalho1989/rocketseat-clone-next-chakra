...
import { Flex, Grid, Text, Link, Box, Tabs, TabList, Tab, TabPanels, TabPanel, Stack } from '@chakra-ui/core'
        ...
        "
                        ...
                        >
                            ...
                            <Flex
                                ...
                                padding={16}
                            >
                                <Text fontSize='2xl' fontWeight='bold' mb='6' > Crie sua conta</Text>
                                <Stack spacing={3}>
                                    <Input
                                        name="email"
            ...
            política de privacidade
                            ...
                            <Flex gridArea="logo" as="aside" flexDir="column" alignItems="flex-start">
                                ...
                                <Text fontSize="4xl" fontWeight="bold" lineHeight="shorter" marginTop={16}>
                                    Mais de 200 mil <br />boosters já estão<br /> conectados.
                    </Text>
                                <Text fontSize="lg" lineHeight="shorter" marginTop={8} color='gray.400'>
                                    Junte-se a milhares de devs e acelere na direção dos
                       <br /> seus objetivos.
                        </Text>

                                <Box mt='8' color="purple.600" display='flex' alignItems='center' >
                                    <MdKeyboardBackspace size={20} />
                                    <Link fontWeight="bold" href='/' ml={4} > Voltar para login</Link>
                                </Box>
...
"
                        ...
                        >
                            ...
                            <Flex
                                ...
                                padding={16}
                            >
                                <Text fontSize='2xl' fontWeight='bold' mb='6' > Cadastro de empresa</Text>
